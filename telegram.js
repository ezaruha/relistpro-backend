...
const CATEGORIES = [
  ...
  { id: 183, title: 'Women > Jeans', keywords: ['jeans','denim','women jeans'] },
  ...
  { id: 11, title: 'Women > Skirts', keywords: ['skirt','pleated','women skirt'] },
  ...
  { id: 73, title: 'Women > Activewear', keywords: ['activewear','sportswear','gym','running','yoga'] },
  { id: 219, title: 'Women > Swimwear > Bikinis', keywords: ['bikini','tankini'] },
  { id: 218, title: 'Women > Swimwear > One-pieces', keywords: ['swimsuit','one-piece','bathing suit'] },
  { id: 28, title: 'Women > Swimwear', keywords: ['swimwear','swimming'] },
  ...
  { id: 29, title: 'Women > Lingerie & Nightwear', keywords: ['lingerie','underwear','knickers'] },
  ...
  // ── Women > Accessories ──
  { id: 21, title: 'Women > Accessories > Jewellery', keywords: ['women jewellery','necklace','bracelet','earrings','ring','women jewelry'] },
  { id: 88, title: 'Women > Accessories > Hats', keywords: ['women hat','beanie','beret','women cap'] },
  ...
  { id: 557, title: 'Women > Accessories > Scarves', keywords: ['scarf','shawl','women scarf'] },
  { id: 559, title: 'Women > Accessories > Gloves', keywords: ['women gloves','mittens'] },
  { id: 558, title: 'Women > Accessories > Hair accessories', keywords: ['hair clip','headband','scrunchie','hair tie','hair accessory'] },
  { id: 1187, title: 'Women > Accessories', keywords: ['accessory','women accessory'] },
  // ── Men > Clothing > Tops ──
  ...
  // ── Men > Clothing > Other ──
  { id: 267, title: 'Men > Jumpers > Hoodies', keywords: ['men hoodie','mens hoodie','men sweatshirt'] },
  ...
  { id: 79, title: 'Men > Jumpers & Sweaters', keywords: ['mens sweater','hoodie','sweatshirt','knitwear'] },
  ...
  { id: 1817, title: 'Men > Jeans > Skinny jeans', keywords: ['men skinny jeans'] },
  { id: 1818, title: 'Men > Jeans > Slim jeans', keywords: ['men slim jeans','slim fit jeans'] },
  { id: 1819, title: 'Men > Jeans > Straight jeans', keywords: ['men straight jeans'] },
  ...
  { id: 584, title: 'Men > Activewear > Sports tops', keywords: ['men sports top','men gym top'] },
  { id: 3267, title: 'Men > Activewear > Team shirts', keywords: ['football shirt','jersey','team shirt','football top'] },
  { id: 582, title: 'Men > Activewear > Tracksuits', keywords: ['men tracksuit','mens tracksuit'] },
  { id: 30, title: 'Men > Activewear', keywords: ['men sportswear','men gym','men activewear'] },
  ...
  // ── Men > Other ──
  { id: 86, title: 'Men > Accessories > Hats', keywords: ['men hat','mens hat','men cap','snapback'] },
  { id: 94, title: 'Men > Accessories > Bags', keywords: ['men bag','mens bag','men rucksack'] },
  ...
  { id: 89, title: 'Men > Accessories > Ties', keywords: ['tie','cufflinks','bow tie'] },
  { id: 90, title: 'Men > Accessories > Wallets', keywords: ['wallet','mens wallet','card holder'] },
  { id: 91, title: 'Men > Accessories > Sunglasses', keywords: ['men sunglasses','mens sunglasses'] },
  { id: 82, title: 'Men > Accessories', keywords: ['men accessory','men accessories'] },
  // ── Kids ──
  ...
  { id: 1764, title: 'Kids > Toys > Soft toys', keywords: ['teddy','plush','soft toy','stuffed animal','cuddly toy'] },
  { id: 1767, title: 'Kids > Toys > Building & blocks', keywords: ['lego','blocks','building','duplo','megabloks'] },
  { id: 1731, title: 'Kids > Toys > Dolls', keywords: ['doll','barbie','action figure','figurine'] },
  { id: 1768, title: 'Kids > Toys > Board games & puzzles', keywords: ['puzzle','board game','jigsaw','card game'] },
  { id: 1766, title: 'Kids > Toys > Outdoor toys', keywords: ['outdoor toy','ride on','scooter','bike','trampoline'] },
  { id: 1499, title: 'Kids > Toys', keywords: ['toy','kids toy','children toy'] },
